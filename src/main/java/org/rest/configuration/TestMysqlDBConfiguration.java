...
public class TestMysqlDBConfiguration {

    private final Logger log = LoggerFactory.getLogger(TestMysqlDBConfiguration.class.getName());

    @Bean
    @ConfigurationProperties(prefix = "datasource.test")
    public DataSource dataSource() {
        log.info("########### Datasource Homologation ###########");
        return DataSourceBuilder.create().build();
    }

    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        log.info("########### LocalContainerEntityManagerFactoryBean Homologation ###########");
